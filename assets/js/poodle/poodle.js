function displayProductpd(productsgl) {
    var productsContainer = $('#products-poodle');
...
$.getJSON('assets/js/data.json', function(data) {
    var goldenProducts = data.dataProducts.filter(function(product_gl) {
        return product_gl.title.toLowerCase().includes('poodle');
    });
    displayProductpd(goldenProducts);
});
