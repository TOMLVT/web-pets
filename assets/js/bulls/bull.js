function displayProductsbull(productsgl) {
    var productsContainer = $('#products-bulls');
...
$.getJSON('assets/js/data.json', function(data) {
    var goldenProducts = data.dataProducts.filter(function(product_gl) {
        return product_gl.title.toLowerCase().includes('bull');
    });
    displayProductsbull(goldenProducts);
});
