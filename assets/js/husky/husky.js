function displayProducts_husky(products) {
    var productsContainer = $('#products-husky');
...
$.getJSON('assets/js/data.json', function(data) {
    var huskyProducts = data.dataProducts.filter(function(product) {
        return product.title.toLowerCase().includes('husky');
    });
    displayProducts_husky(huskyProducts);
});
